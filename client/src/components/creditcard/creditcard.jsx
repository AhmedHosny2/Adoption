			...
			<div className="CC-flip-card">
				<div className="CC-flip-card-inner">
					<div className="CC-flip-card-front">
						<p className="CC-heading_8264">MASTERCARD</p>
						<svg
							className="CC-logo"
              ...
              MDowMIXeN6gAAAAASUVORK5CYII="
						...
						<p className="CC-number">9759 2484 5269 6576</p>
						<p className="CC-valid_thru">VALID THRU</p>
						<p className="CC-date_8264">1 2 / 2 4</p>
						<p className="CC-name">BRUCE WAYNE</p>
					</div>
					<div className="CC-flip-card-back">
						<div className="CC-strip"></div>
						<div className="CC-mstrip"></div>
						<div className="CC-sstrip">
							<p className="CC-code">***</p>
						</div>
					</div>
				</div>
			</div>
